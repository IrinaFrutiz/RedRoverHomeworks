...
public class Main {
    public static void main(String[] args) {
        ...
        Director ira = new Director("Six", 10000, 5);
        ...
        System.out.println(EmployeeUtil.getHigherSalary(all).getName());
        System.out.println(EmployeeUtil.getLowerSalary(all).getName());
